...
Sms settings microservice can be used in different deployment scenarios.
...
var plugin = require('pip-services-smssettings-node').SmsSettingsSenecaPlugin;
...
or by using [SmsSettingsSenecaClient](https://github.com/pip-services-users/pip-clients-smssettings-node/NodeClientApiV1.md/#client_seneca)