...
class SmsSettingsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
SmsSettingsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "factory", "default", "default", "1.0");
SmsSettingsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "persistence", "memory", "*", "1.0");
SmsSettingsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "persistence", "file", "*", "1.0");
SmsSettingsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "persistence", "mongodb", "*", "1.0");
SmsSettingsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "controller", "default", "*", "1.0");
SmsSettingsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "service", "seneca", "*", "1.0");
SmsSettingsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-smssettings", "service", "http", "*", "1.0");
