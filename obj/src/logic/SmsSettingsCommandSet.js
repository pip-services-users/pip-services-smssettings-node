...
class SmsSettingsCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetSettingsBySmsSettingsCommand() {
        return new pip_services3_commons_node_2.Command("get_settings_by_phone", new pip_services3_commons_node_3.ObjectSchema(true)
            .withRequiredProperty('phone', pip_services3_commons_node_5.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeSetRecipientCommand() {
        return new pip_services3_commons_node_2.Command("set_recipient", new pip_services3_commons_node_3.ObjectSchema(true)
            ...
            .withOptionalProperty('phone', pip_services3_commons_node_5.TypeCode.String)
    ...
    makeVerifySmsCommand() {
        return new pip_services3_commons_node_2.Command("verify_phone", new pip_services3_commons_node_3.ObjectSchema(true)
            .withRequiredProperty('recipient_id', pip_services3_commons_node_5.TypeCode.String), (correlationId, args, callback) => {
            let recipientId = args.getAsString("recipient_id");
